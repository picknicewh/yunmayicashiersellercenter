...
import com.yun.ma.yi.app.widget.OnWheelChangedListener;
import com.yun.ma.yi.app.widget.OnWheelClickedListener;
import com.yun.ma.yi.app.widget.WheelView;
import com.yun.ma.yi.app.widget.adapters.ArrayWheelAdapter;
import com.yun.ma.yi.app.widget.adapters.NumericWheelAdapter;
...
public class SelectDateDialog extends Dialog{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mMounth.addClickingListener(new OnWheelClickedListener() {
		...
		mDay.addClickingListener(new OnWheelClickedListener() {
